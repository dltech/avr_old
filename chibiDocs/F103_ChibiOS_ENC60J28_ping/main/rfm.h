#ifndef RFM_H_INCLUDED
#define RFM_H_INCLUDED

#define RFM_RESET_PORT 		GPIOA
#define RFM_RESET_PIN			GPIOB_RFM_RST

#define RFM_NSS_PORT 			GPIOA
#define RFM_NSS_PIN				GPIOB_RFM_NSS

#define RFM_DIO0_PORT 		GPIOB
#define RFM_DIO0_PIN			GPIOB_RFM_DIO0

#define RFM_DIO1_PORT 		GPIOA
#define RFM_DIO1_PIN			GPIOB_RFM_DIO1

//#define RFM_DIO2_PORT 		GPIOA
//#define RFM_DIO2_PIN			GPIOA_RFM_DIO2

//#define RFM_DIO3_PORT 		GPIOA
//#define RFM_DIO3_PIN			GPIOA_RFM_DIO3

//#define RFM_DIO5_PORT 		GPIOA
//#define RFM_DIO5_PIN			GPIOA_RFM_DIO5
...
/** @file rfm.h @brief В этом файле содержатся настройки радиомодуля, некоторые макросы для конфигурации микроконтроллера и прототипы функций.
...
// FSK parametres
#define DEVIATION						10000			///< частота девиации в Гц
...
/**	@name		Функция перезапуска модуля		 	**/
